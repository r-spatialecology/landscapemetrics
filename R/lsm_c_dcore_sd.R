    ...
    result <- lapply(X = landscape,
                     FUN = function(x) {
                         ...
                         lsm_class_output(metric = "dcore_sd",
                                          class = as.integer(names(dcore_sd)),
                                          value = unname(dcore_sd))
                     })
...
lsm_c_dcore_sd_calc <- function(landscape_mat, directions, consider_boundary, edge_depth,
