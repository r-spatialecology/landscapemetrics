...
lsm_l_cai_cv_calc <- function(landscape_mat, directions = NULL, consider_boundary = FALSE, edge_depth = 1, resolution = NULL,
    ...
    cai_cv <- stats::sd(cai_patch) / mean(cai_patch) * 100
