...
#' differences among patches of the same class i in the landscape. Because the metric is
#' based on distances or areas please make sure your data is valid using \code{\link{check_landscape}}.
#'
