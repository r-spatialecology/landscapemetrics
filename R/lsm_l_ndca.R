...
#'
#' @export
lsm_l_ndca <- function(landscape, directions, consider_boundary) UseMethod("lsm_l_ndca")

#' @name lsm_l_ndca
#' @export
lsm_l_ndca.RasterLayer <- function(landscape, directions = 8, consider_boundary = FALSE) {
...
#' @name lsm_l_ndca
#' @export
lsm_l_ndca.RasterStack <- function(landscape, directions = 8, consider_boundary = FALSE) {
...
#' @name lsm_l_ndca
#' @export
lsm_l_ndca.RasterBrick <- function(landscape, directions = 8, consider_boundary = FALSE) {
...
#' @name lsm_l_ndca
#' @export
lsm_l_ndca.stars <- function(landscape, directions = 8, consider_boundary = FALSE) {
...
#' @name lsm_l_ndca
#' @export
lsm_l_ndca.list <- function(landscape, directions = 8, consider_boundary = FALSE) {
...
lsm_l_ndca_calc <- function(landscape, directions, consider_boundary){
