...
lsm_calculate_internal <- function(landscape, what, ...) {
    ...
    if(what == "all") {
        ...
        result <- dplyr::bind_rows(
            ...
            lsm_c_tca(landscape),
            lsm_c_tca_cv(landscape),
            lsm_c_tca_mn(landscape),
            lsm_c_tca_sd(landscape),
            ...
            lsm_c_ndca_cv(landscape),
            lsm_c_ndca_mn(landscape),
            lsm_c_ndca_sd(landscape),
            lsm_c_np(landscape),
            ...
            lsm_l_ndca_cv(landscape),
            lsm_l_ndca_mn(landscape),
            lsm_l_ndca_sd(landscape),
            lsm_l_np(landscape),
