...
lsm_l_enn_mn <- function(landscape, directions = 8, verbose = TRUE) {
    ...
    result <- lapply(X = landscape,
                     FUN = function(x) {
                         ...
                         lsm_landscape_output(metric = "enn_mn", value = enn_mn)
                     })
...
lsm_l_enn_mn_calc <- function(landscape_mat, directions = NULL, verbose = TRUE, resolution = NULL, enn_patch = NULL) {
    ...
    enn_mn <- mean(enn_patch)

    return(as.double(enn_mn))
}
