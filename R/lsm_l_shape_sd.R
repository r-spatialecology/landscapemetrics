...
lsm_l_shape_sd_calc <- function(landscape_mat, directions = NULL, resolution = NULL,
    ...
    # calculate sd of all patches
    shape_sd <- stats::sd(unname(shape_patch))
