...
lsm_l_dcore_cv_calc <- function(landscape_mat, directions = NULL, consider_boundary = FALSE, edge_depth = 1, resolution = NULL,
    ...
    dcore_cv <- stats::sd(dcore_patch) / mean(dcore_patch) * 100
