...
rcpp_xy_from_matrix2 <- function(x, cell = NULL) {
    .Call('_landscapemetrics_rcpp_xy_from_matrix2', PACKAGE = 'landscapemetrics', x, cell)
}

rcpp_cell_from_xy2 <- function(x, y) {
    .Call('_landscapemetrics_rcpp_cell_from_xy2', PACKAGE = 'landscapemetrics', x, y)
}

rcpp_create_neighborhood2 <- function(directions) {
    .Call('_landscapemetrics_rcpp_create_neighborhood2', PACKAGE = 'landscapemetrics', directions)
}
...
rcpp_get_coocurrence_matrix_old <- function(x, directions) {
