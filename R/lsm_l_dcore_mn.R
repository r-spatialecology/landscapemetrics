...
lsm_l_dcore_mn <- function(landscape,
    ...
    result <- lapply(X = landscape,
                     FUN = function(x) {
                         ...
                         lsm_landscape_output(metric = "dcore_mn", value = dcore_mn)
                     })
...
lsm_l_dcore_mn_calc <- function(landscape_mat, directions = NULL, consider_boundary = FALSE, edge_depth = 1, resolution = NULL,
    ...
    dcore_mn <- mean(dcore_patch)

    return(as.double(dcore_mn))
}
