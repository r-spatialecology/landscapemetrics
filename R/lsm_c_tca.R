...
#' because the sum of edges increase as patches are less aggregated. Because the metric is
#' based on distances or areas please make sure your data is valid using
