...
**FRAGSTATS** is unfortunately not an open-source project, so we can't definetly say
...
However, while we can proof that our method works as description of the core metric
in the FRAGSTATS manual the results of the FRAGSTATS software itself can not be replicated.
