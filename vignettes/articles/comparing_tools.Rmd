...
While it seems like FRAGSTATS uses the largest distance between the corner points of the cells, this does not necessarily result in the correct circumscribingcircle 
