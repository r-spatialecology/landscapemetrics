...
lsm_a <- terra::unwrap(landscapemetrics:::landscape_background$`a) Continous Landscape`)
lsm_b <- terra::unwrap(landscapemetrics:::landscape_background$`b) Categorical Landscape`)

terra::plot(c(lsm_a, lsm_b))
```
