...
lsm_a <- terra::rast(landscapemetrics:::landscape_background$`a) Continous Landscape`)
lsm_b <- terra::rast(landscapemetrics:::landscape_background$`b) Categorical Landscape`)
