...
- [lsm_l_joinent](https://marcosci.github.io/landscapemetrics/reference/lsm_l_joinent.html): an overall spatio-thematic complexity metric.
- [lsm_l_ent](https://marcosci.github.io/landscapemetrics/reference/lsm_l_ent.html): a diversity (thematic complexity) of landscape classes
- [lsm_l_condent](https://marcosci.github.io/landscapemetrics/reference/lsm_l_condent.html): a complexity of a landscape pattern configuration. It measures a only a geometric intricacy (configurational complexity) of a landscape pattern.
- [lsm_l_mutinf](https://marcosci.github.io/landscapemetrics/reference/lsm_l_mutinf.html):  disambiguates landscape pattern types characterize by the same value of an overall complexity.
