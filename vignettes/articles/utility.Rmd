...
We can use the `show_landscape` function from [landscapetools](https://github.com/ropensci/landscapetools) to have look
at our landscape.
...
This is how we typically inspect our landscape, but which also makes it quite hard to relate to the landscape metrics 
we are interested in. This why we show in the following how to dissect this landscape visually into the compoments,
that drive the calculation of landscape metrics.
