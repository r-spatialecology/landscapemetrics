...
test_2 <- landscapemetrics:::matrix_to_raster(pad_raster(test, pad_raster_value = NA), landscape)
landscapetools::util_plot(test_2)
boundarie_mat <- rcpp_get_boundaries(raster::as.matrix(test_2), as.matrix(4))
