...
test_that("lsm_p_ncore results are equal to fragstats", {
    expect_true(all(fragstats_patch_landscape_ncore %in%
                        landscapemetrics_patch_landscape_ncore$value))
    expect_true(all(fragstats_patch_landscapestack_ncore %in%
                        landscapemetrics_patch_landscape_stack_ncore$value))
    expect_true(all(fragstats_patch_augusta_nlcd_ncore %in%
                        landscapemetrics_patch_augusta_nlcd_ncore$value))
})
