...
land_result1 = rcpp_get_coocurrence_matrix(raster::as.matrix(landscape), directions = 4)
land_result2 = rcpp_get_coocurrence_matrix(raster::as.matrix(podlasie_ccilc), directions = 4)
