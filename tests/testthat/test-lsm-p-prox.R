...
test_that("lsm_p_prox results are equal to fragstats", {
    expect_true(all(fragstats_patch_landscape_prox %in%
                        landscapemetrics_patch_landscape_prox$value))
    expect_true(all(fragstats_patch_landscapestack_prox %in%
                        landscapemetrics_patch_landscape_stack_prox$value))
    expect_true(all(fragstats_patch_augusta_nlcd_prox %in%
                        landscapemetrics_patch_augusta_nlcd_prox$value))
})
