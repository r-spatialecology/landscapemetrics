...
test_that("lsm_c_shape_mn results are equal to fragstats", {
    expect_true(all(fragstats_class_landscape_shape_mn %in%
                        round(landscapemetrics_class_landscape_shape_mn$value, 4)))
})
...
test_that("lsm_c_shape_mn returns the desirshape_mn number of columns", {
