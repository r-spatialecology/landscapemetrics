...
test_that("lsm_p_ca results are equal to fragstats", {
...
test_that("lsm_p_ca returns the desired number of columns", {
    expect_equal(ncol(landscapemetrics_class_landscape_ca), 6)
})

test_that("lsm_p_ca returns in every column the correct type", {
