...
All of them are implemented with Rcpp and have either memory or perfomance advantages
compared to raster functions.

For more details, see the [utility function vignette](https://landscapeecology.github.io/landscapemetrics/articles/articles/utility.html).
